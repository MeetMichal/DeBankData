...
{
    public partial class TrustsChart : BaseChartComponent
    {
        ...
        {
            var byBalance = UserRanks.OrderByDescending(u => u.Trust).ToList();
            int index = 0;

            Series = byBalance.Take(10).Select(u => u.Trust).AsPieSeries((value, series) =>
            {
